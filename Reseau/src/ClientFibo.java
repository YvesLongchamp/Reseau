...
/**
 * Classe client, pour demander un fibonacci, et avoir le résultat.
 *
 */
public class ClientFibo {
	...
	public static void main(String[] args) {// On recupere les arguments de la
											...
											// resultat.
		ClientFibo client = new ClientFibo(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
		client.clientRun();
	 ...
	 * de fibonacci. On voudra avoir le resultat.
	 */
